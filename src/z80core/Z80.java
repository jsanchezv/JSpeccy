...
//            }
            ...
            case 0xC5: {     /* PUSH BC */
                MemIoImpl.contendedStates(getPairIR(), 1);
                regSP--;
                MemIoImpl.poke8(regSP & 0xffff, regB);
                regSP = (regSP - 1) & 0xffff;
            ...
            case 0xD5: {     /* PUSH DE */
                MemIoImpl.contendedStates(getPairIR(), 1);
                regSP--;
                MemIoImpl.poke8(regSP & 0xffff, regD);
                regSP = (regSP - 1) & 0xffff;
            ...
            case 0xE5:       /* PUSH HL */
                MemIoImpl.contendedStates(getPairIR(), 1);
                regSP--;
                MemIoImpl.poke8(regSP & 0xffff, regH);
                regSP = (regSP - 1) & 0xffff;
            ...
            case 0xF5:       /* PUSH AF */
                MemIoImpl.contendedStates(getPairIR(), 1);
                regSP--;
                MemIoImpl.poke8(regSP & 0xffff, regA);
                regSP = (regSP - 1) & 0xffff;
